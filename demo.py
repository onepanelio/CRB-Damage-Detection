...
if __name__ == "__main__":
    ...
    parser.add_argument("--od_model", default="./data/frozen_inference_graph_5classes.pb" , help="path to trained detection model")
    parser.add_argument("--classes_cvat", default="./data/5classes.csv", help="classes you want to use for cvat, see readme for more details.")
    parser.add_argument("--classes_type", default="od", help="type of classes csv file [od, maskrcnn]")
    parser.add_argument("--mask_model", default="./data/mask_rcnn_cvat_0160.h5", help="path to trained maskrcnn model")
